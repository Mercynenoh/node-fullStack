...
SELECT * FROM Projects WHERE assigned='0'`)).recordset;
    for (let project of projects) {
        ejs_1.default.renderFile('template/project.ejs', { email: project.email }, (error, data) => __awaiter(void 0, void 0, void 0, function* () {
            let messageoption = {
            ...
            try {
                ...
                yield pool.request().query(`UPDATE Projects SET assigned='1' WHERE UsersId = '${project.email}'`);
